...
const FormularioUniversidad = () => {
  ...
  const allQuestions = {
    ...
    q1: {
      ...
      options: [
        { id: 'a', text: "Resolver problemas matemáticos", area: "ciencias", nextQuestion: 2 },
        { id: 'b', text: "Leer y analizar textos", area: "humanidades", nextQuestion: 3 },
        { id: 'c', text: "Ayudar a personas o animales", area: "salud", nextQuestion: 4 },
        { id: 'd', text: "Crear o diseñar elementos visuales", area: "artes", nextQuestion: 5 },
        { id: 'e', text: "Coordinar y gestionar equipos", area: "administrativas", nextQuestion: 6 }
      ]
    },
    // Preguntas para ciencias
    q2: {
      id: 2,
      question: "Dentro de las ciencias, ¿cuál de estas áreas te llama más la atención?",
      options: [
        { id: 'a', text: "Matemáticas y estadísticas", area: "ciencias", subarea: "matematicas", nextQuestion: 7 },
        { id: 'b', text: "Física y tecnologías aplicadas", area: "ciencias", subarea: "ingenierias", nextQuestion: 7 },
        { id: 'c', text: "Tecnologías de la información", area: "ciencias", subarea: "computacion", nextQuestion: 7 },
        { id: 'd', text: "Investigación científica", area: "ciencias", subarea: "investigacion", nextQuestion: 7 }
      ]
    },
    // Preguntas para humanidades
    q3: {
      id: 3,
      question: "En el campo de las humanidades, ¿qué tipo de estudios te interesan más?",
      options: [
        { id: 'a', text: "Literatura y escritura creativa", area: "humanidades", subarea: "literatura", nextQuestion: 7 },
        { id: 'b', text: "Historia y cultura global", area: "humanidades", subarea: "historia", nextQuestion: 7 },
        { id: 'c', text: "Filosofía y reflexión crítica", area: "humanidades", subarea: "filosofia", nextQuestion: 7 },
        { id: 'd', text: "Lenguas extranjeras y traducción", area: "humanidades", subarea: "lenguas", nextQuestion: 7 }
      ]
    },
    ...
    q4: {
      ...
      options: [
        { id: 'a', text: "Medicina y cirugía", area: "salud", subarea: "medicina", nextQuestion: 7 },
        { id: 'b', text: "Cuidado de la salud y bienestar", area: "salud", subarea: "enfermeria", nextQuestion: 7 },
        { id: 'c', text: "Psicología y salud mental", area: "salud", subarea: "psicologia", nextQuestion: 7 },
        { id: 'd', text: "Prevención y nutrición", area: "salud", subarea: "nutricion", nextQuestion: 7 }
      ]
    },
    ...
    q5: {
      ...
      options: [
        { id: 'a', text: "Artes visuales (pintura, escultura)", area: "artes", subarea: "bellasartes", nextQuestion: 7 },
        { id: 'b', text: "Diseño gráfico y digital", area: "artes", subarea: "diseno", nextQuestion: 7 },
        { id: 'c', text: "Arquitectura y diseño de espacios", area: "artes", subarea: "arquitectura", nextQuestion: 7 },
        { id: 'd', text: "Música y artes escénicas", area: "artes", subarea: "musica", nextQuestion: 7 }
      ]
    },
    // Preguntas para administrativas
    q6: {
      id: 6,
      question: "En el mundo de los negocios, ¿qué actividades encuentras más atractivas?",
      options: [
        { id: 'a', text: "Gestión y administración de empresas", area: "administrativas", subarea: "administracion", nextQuestion: 7 },
        { id: 'b', text: "Contabilidad y gestión financiera", area: "administrativas", subarea: "finanzas", nextQuestion: 7 },
        { id: 'c', text: "Marketing y relaciones comerciales", area: "administrativas", subarea: "mercadotecnia", nextQuestion: 7 },
        { id: 'd', text: "Emprender y desarrollar nuevos negocios", area: "administrativas", subarea: "emprendimiento", nextQuestion: 7 }
      ]
    },
    ...
    q7: {
      ...
      options: [
        ...
        { id: 'd', text: "Trabajo de investigación o teórico", nextQuestion: 8 }
      ]
    },
    q8: {
      id: 8,
      ...
      options: [
        ...
        { id: 'c', text: "Al aire libre o en un entorno móvil", nextQuestion: 9 },
        { id: 'd', text: "En un ambiente remoto o desde casa", nextQuestion: 9 }
      ]
    },
    q9: {
      id: 9,
      ...
      options: [
        ...
        { id: 'c', text: "Contribución cultural y artística", nextQuestion: 10 },
        { id: 'd', text: "Desarrollo económico y empresarial", nextQuestion: 10 }
      ]
    },
    q10: {
      id: 10,
  ...
  const calculateResult = () => {
    ...
    const subArea = answers[1]?.subarea || answers[2]?.subarea || answers[3]?.subarea || answers[4]?.subarea || answers[5]?.subarea || answers[6]?.subarea;
              ...
              <div className="comment-modal">
                ...
                <div className="comment-modal-actions">
                  ...
                  <button 
                    ...
                    onClick={() => {
                      console.log(`Comentario enviado para ${selectedCareer}: ${commentText}`);
          ...
          {showNotificationModal && (
            <div className="notification-modal-overlay">
              <div className="notification-modal">
                <p>¡Notificaciones {notifications[selectedCareer] ? 'activadas' : 'desactivadas'} para {selectedCareer}!</p>
                <button onClick={() => setShowNotificationModal(false)}>Aceptar</button>
              </div>
            </div>
          )}
          ...
          <div className="careers-list">
            {recommendedCareers.length > 0 ? (
                    ...
                    return (
                      <li key={index} className="career-item">
                        ...
                        <p className="career-description">
                          {getCareerDescription(careerName)} • {getInstitutionDescription(institutionName)}
                        </p>
                        <div className="career-actions">
                          ...
                          <button 
                            className={`notify-button ${notifications[careerName] ? 'active' : ''}`}
              ...
              <p className="no-results">
                No pudimos determinar carreras específicas. Te recomendamos explorar las opciones 
                de la <a href="https://www.uady.mx" target="_blank" rel="noopener noreferrer">UADY</a>, 
                el <a href="https://www.merida.tecnm.mx" target="_blank" rel="noopener noreferrer">Tec de Mérida</a> o 
                la <a href="https://www.anahuac.mx/merida" target="_blank" rel="noopener noreferrer">Anáhuac Mayab</a>.
              </p>
            )}
          </div>
